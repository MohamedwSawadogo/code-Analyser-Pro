...
################################################################################
## Form generated from reading UI file 'reel_connexion.ui'
##
...
import im_rc
import r_connexion_rc

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"Connexion")
        ...
        self.label_2.setStyleSheet(u"image: url(:/r_connexion/SII-removebg-preview.png);")
...
"")
        ...
        self.pushButton.setMinimumSize(QSize(550, 61))
        self.pushButton.setMaximumSize(QSize(550, 61))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Nom d'utilisateur", None))
