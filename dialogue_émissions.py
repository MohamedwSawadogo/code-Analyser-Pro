...
################################################################################
## Form generated from reading UI file 'dialogue_émissions.ui'
##
...
from PySide6.QtWidgets import QApplication, QComboBox, QDialog, QFrame, QLabel, QPushButton, QVBoxLayout, QWidget, QMessageBox
from classes_analyse import EmissionDataVisualizer, EmissionAnalysis
...
class Ui_Dialog(QDialog):
    def __init__(self, main_window, data, parent=None):
        ...
        self.pushButton_31.clicked.connect(self.open_output_selection_dialog)
 

    def setupUi(self, Dialog):
        if not Dialog.objectName():
            Dialog.setObjectName(u"Émissions")
            Dialog.setWindowTitle("Émissions")
        ...
        self.label.setGeometry(QRect(30, 10, 271, 31))
...
"}")
        ...
        self.pushButton_31.setGeometry(QRect(10, 70, 379, 41))
        font2 = QFont()
...
"}")
        ...
        self.pushButton_33.setGeometry(QRect(10, 140, 379, 41))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"\u00c9missions", None))
        self.pushButton_30.setText(QCoreApplication.translate("Dialog", u"Analyser", None))
        self.pushButton_31.setText(QCoreApplication.translate("Dialog", u"Choisir le type d'\u00e9mission \u00e0 analyser", None))
    ...
    def analyze_data(self):
        ...
        analysis = EmissionAnalysis(self.main_window.data, input_column, output_columns, self.main_window.emission_reference_handler)
        results, anomalies = analysis.analyze()
        visualizer = EmissionDataVisualizer(self.main_window.data, self.main_window.chart_layout)
        visualizer.plot_with_reference(input_column, results)
        self.main_window.populate_table(anomalies, ["Temps", "Paramètre/Polluant", "Valeur", "Écart (%)", "Commentaire", "Correction"])
